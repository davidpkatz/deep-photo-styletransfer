...
RUN git clone https://github.com/luanfujun/deep-photo-styletransfer.git
RUN cd deep-photo-styletransfer/models
...
RUN wget -c http://www.robots.ox.ac.uk/~vgg/software/very_deep/caffe/VGG_ILSVRC_19_layers.caffemodel
RUN wget -c http://sceneparsing.csail.mit.edu/model/DilatedNet_iter_120000.caffemodel
